...
contract('AngleRouterLinea', () => {
  ...
  before(async () => {
    ...
    wETH = (await ethers.getContractAt(ERC20__factory.abi, '0xe5D7C2a44FfDDf6b295A15c148167daaAf5Cf34f')) as ERC20;
  ...
  beforeEach(async () => {
    await hre.network.provider.request({
      ...
      params: [
        {
          forking: {
            jsonRpcUrl: process.env.ETH_NODE_URI_LINEA,
            // Changing Linea fork block breaks some tests
            blockNumber: 6958729,
          },
        },
      ],
    ...
    router = (await deployUpgradeable(new AngleRouterLinea__factory(deployer))) as AngleRouterLinea;
